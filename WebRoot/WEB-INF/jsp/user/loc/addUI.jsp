	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9  col-md-10  main" style="margin-top: 70px">
				<form action="${basePath}user/loc_add.action" method="post" class="form-horizontal">
					<div class="form-group">
						<label for="inputType" class="col-sm-2 control-label">类型</label>
						<div class="col-sm-10">
							<s:select name="loc.type" cssClass="form-control" list="#{'教学楼':'教学楼','宿舍':'宿舍','接待处':'接待处','食堂':'食堂','洗浴中心':'洗浴中心','缴费处':'缴费处'}" />
						</div>
					</div>
					<div class="form-group">
